...
export default async function JDTailoringHubPage() {
      ...
      <div className="max-w-2xl mx-auto">
        <div className="animate-fade-up glass rounded-2xl p-16 border border-brand-secondary/40 text-center relative overflow-hidden">
          ...
          <p className="text-gray-600 mb-6 max-w-md mx-auto relative">
            Upgrade to get specific, reviewable resume changes for every job you&apos;re tracking — reworded bullets,
            skills to add or trim, and a tailored summary, each grounded in your real achievements.
          </p>
  ...
  return (
    <JobPickerHub
      ...
      description="Pick a job to review specific, approve-or-reject resume changes tailored to its description."
      icon={<Target className="w-4.5 h-4.5" />}
      jobs={jobs ?? []}
      hrefPrefix="/jd-tailoring"
      emptyMessage="No jobs yet. Add one to start tailoring your resume for it."
    />
  );
}
