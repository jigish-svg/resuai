    ...
    <div className="space-y-4">
      <div className="animate-fade-up glass rounded-2xl p-6 border border-black/[0.06]">
        <textarea
          ...
          rows={20}
          className="w-full bg-black/[0.02] border border-black/[0.06] rounded-xl p-4 text-sm leading-relaxed focus:outline-none focus:border-brand-primary/60 focus:bg-white transition-colors resize-y"
        />
      </div>
